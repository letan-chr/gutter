...
const Gallery = () => {
  ...
  const handlePrevious = React.useCallback(() => {
    if (selectedImageIndex === null || isAnimating || images.length === 0) return;
    setIsAnimating(true);
    setTimeout(() => {
      ...
      <section className="py-12 lg:py-20 bg-white dark:bg-gray-900 min-h-screen">
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
          <div className="text-center">
            <p className="text-gray-600 dark:text-gray-400">No gallery images available.</p>
          </div>
        </div>
      </section>
    );
          ...
          {images.map((image: any, index: number) => (
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none">
                <Image
                  src={image.image || '/placeholder-gallery.jpg'}
                  alt={image.title}
                  fill
            ...
            >
              ...
              <div className="relative flex-1 flex items-center justify-center p-6 md:p-8 bg-gray-900 dark:bg-gray-800 min-h-[400px]">
                ...
                <div className="relative w-full max-w-4xl aspect-video overflow-hidden rounded-lg bg-gray-800">
                  ...
                  >
                    <Image
                      src={images[selectedImageIndex].image || '/placeholder-gallery.jpg'}
