                ...
                if (item.items && item.items.length > 0) {
                  return (
                    <div key={index} className="flex flex-col">
                      <button
                        onClick={() => setMobileCompanyDropdownOpen(!mobileCompanyDropdownOpen)}
        ...
        <div className="overflow-y-auto h-[calc(100%-80px)] p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <p className="text-gray-700 dark:text-gray-300 font-medium">{footerData.contact.address}</p>
                </div>
              </div>

              <a href={`tel:${footerData.contact.phone}`} className="flex items-start gap-3 group">
                <div className="w-10 h-10 rounded-lg bg-primary/10 dark:bg-primary/20 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 dark:group-hover:bg-primary/30 transition-colors">
                  <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a href={`mailto:${footerData.contact.email}`} className="flex items-start gap-3 group">
                <div className="w-10 h-10 rounded-lg bg-primary/10 dark:bg-primary/20 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 dark:group-hover:bg-primary/30 transition-colors">
                  <svg className="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
            ...
            <div className="grid grid-cols-2 gap-2">
              {footerData.links.quickLinks.items.map((link: any, index: number) => (
                <a
                  key={index}
                  href={link.url}
                  onClick={() => setOffcanvasOpen(false)}
          ...
          <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
            ...
            <div className="flex gap-3">
              {footerData.social.links.map((social: any, index: number) => (
                ...
                >
                  <svg className="w-6 h-6 text-primary dark:text-primary-light" fill="currentColor" viewBox="0 0 24 24">
