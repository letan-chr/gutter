...
const Hero = () => {
  ...
  const slides: SlideData[] = useMemo(() => [
    ...
    },
    {
      ...
      title: lang === 'en' ? 'Premium Office & Shop Rental Spaces' : 'ደረጃቸዉን የጠበቁ ለሱቅ እና ለቢሮ የሚሆኑ ክፍሎች',
      description: lang === 'en' 
    ...
    },
    {
      ...
      description: lang === 'en'
        ...
        : 'ለልዩ ቀንዎ ውብ የሆነ የሰርግ አዳራሽ፤ በዘመናዊ ቁሳቁሶች የተሟላ አዳራሽ፤ ሰፊ፣ የተዋበ እና የማይረሳ ጊዜን የሚያሳልፉበት።',
