...
import { ServiceListResponse, ServiceType } from "@/types/types";
import { getAllServicesWithPagination } from "@/api/Api";
...
const Service = () => {
  ...
  useEffect(() => {
    async function fetchServices() {
      try {
        const res = await getAllServicesWithPagination({
          page,
          per_page: PER_PAGE,
        });

        const resolved = res.data.map((service) =>
              ...
              >
                ...
                >
                  ...
                  <div
                    ...
                    } p-10 lg:p-14 lg:col-span-6 h-full
                  ...
                  >
                    ...
                    <div className="relative w-[260px] h-[260px] md:w-[300px] md:h-[300px] lg:w-[340px] lg:h-[340px] lg:min-h-[340px] xl:w-[380px] xl:h-[380px] xl:min-h-[380px] 2xl:w-[420px] 2xl:h-[420px] 2xl:min-h-[420px] flex-shrink-0 my-auto">
                      ...
                      {/* inner ring */}
                      <div
                        className="absolute inset-6 rounded-full border-2 border-secondary/30 animate-spin-slow"
